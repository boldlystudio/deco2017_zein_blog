...
<div class="blog-image">
  <img src="/deco2017_zein_blog/assets/images/discovery-summary.png" alt="Discovery report summary">
...
<div class="blog-image">
  <img src="/deco2017_zein_blog/assets/images/bakelab-wireframe.png" alt="BakeLab wireframe">
  <p class="image-caption">
...
# Reflection on Early Assumptions

One of the biggest changes during this stage was recognising that BakeLab could easily become overloaded with features. At first, I assumed adding more social functionality would make the platform feel more engaging. However, the more I explored the discovery research and wireframes, the clearer it became that too many social features would weaken the core learning experience.

For example, features such as real-time chat, large discussion threads, and reaction systems initially seemed useful for community interaction. However, these features also risked shifting user attention away from structured critique and process analysis.
